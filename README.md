...
- Your own Telegram API ID and API hash create on [Press Me](https://my.telegram.org)
...
2. Add your own Telegram API credentials to `config.h`.

3. Open `Telegram.xcworkspace` in Xcode.

4. Select the `Telegraph` scheme and configure your bundle identifier and signing settings.

5. Build for an iOS device or simulator.
...
Please sub to RedGram Telegram [channel](https://t.me/RedGramiOS6)
