...
static UIImage *TGClassicIOS6DarkInputFieldImage(void)
{
    CGSize size = CGSizeMake(33.0f, 33.0f);
    UIGraphicsBeginImageContextWithOptions(size, false, 0.0f);
    UIBezierPath *path = [UIBezierPath bezierPathWithRoundedRect:CGRectInset((CGRect){CGPointZero, size}, 0.5f, 0.5f) cornerRadius:16.0f];
    [UIColorRGB(0x111111) setFill];
    [path fill];
    [UIColorRGB(0x303030) setStroke];
    path.lineWidth = 1.0f;
    [path stroke];
...
- (void)setPresentation:(TGPresentation *)presentation
{
    ...
    bool classicIOS6 = [TGPresentation classicIOS6Style];
    UIColor *toolbarColor = UIColorRGB(0x111111);
    UIColor *toolbarIconColor = UIColorRGB(0xf0f0f0);
    
    _micButton.pallete = presentation.micButtonPallete;
    
    _fieldBackground.image = classicIOS6 ? TGClassicIOS6DarkInputFieldImage() : presentation.images.chatInputFieldImage;
    ...
    if (classicIOS6)
    {
        ...
        _classicIOS6BackgroundGradient.colors = @[(id)UIColorRGB(0x1d1d1d).CGColor, (id)UIColorRGB(0x080808).CGColor];
        _classicIOS6BackgroundGradient.locations = @[@0.0f, @1.0f];
        _classicIOS6BackgroundGradient.hidden = false;
        _backgroundView.backgroundColor = toolbarColor;
        _stripeView.backgroundColor = [UIColor blackColor];
        [_attachButton setImage:[TGPresentationAssets inputPanelAttachIcon:toolbarIconColor accentColor:nil] forState:UIControlStateNormal];
        [_sendButton setImage:[TGPresentationAssets inputPanelSendIcon:UIColorRGB(0x2a2a2a) color:toolbarIconColor] forState:UIControlStateNormal];
        [_stickerModeButton setImage:[TGPresentationAssets inputPanelStickersIcon:toolbarIconColor] forState:UIControlStateNormal];
        [_commandModeButton setImage:[TGPresentationAssets inputPanelBotKeyboardIcon:toolbarIconColor] forState:UIControlStateNormal];
        [_slashModeButton setImage:[TGPresentationAssets inputPanelCommandsIcon:toolbarIconColor] forState:UIControlStateNormal];
        [_broadcastButton setImage:[TGPresentationAssets inputPanelBroadcastIcon:toolbarIconColor active:_isBroadcasting] forState:UIControlStateNormal];
        [_keyboardModeButton setImage:[TGPresentationAssets inputPanelKeyboardIcon:toolbarIconColor] forState:UIControlStateNormal];
        [_clearButton setImage:[TGPresentationAssets inputPanelClearIcon:toolbarColor color:toolbarIconColor] forState:UIControlStateNormal];
        _micButtonIconView.image = self.isVideoMessage ? [TGPresentationAssets inputPanelVideoMessageIcon:toolbarIconColor] : [TGPresentationAssets inputPanelMicrophoneIcon:toolbarIconColor];
    }
    else
    {
        if (_classicIOS6BackgroundGradient != nil)
    ...
    UIImage *arrowImage = classicIOS6 ? [TGPresentationAssets inputPanelArrowIcon:toolbarIconColor] : presentation.images.chatInputArrowIcon;
    ...
    _inputField.textColor = classicIOS6 ? toolbarIconColor : presentation.pallete.chatInputTextColor;
    _inputField.accentColor = classicIOS6 ? toolbarIconColor : presentation.pallete.accentColor;
    ...
    _customKeyboardWrapperView.backgroundColor = classicIOS6 ? toolbarColor : presentation.pallete.barBackgroundColor;
...
- (void)updateSendButtonVisibility:(bool)animated
{
    ...
    if (_messageEditingContext != nil) {
        if (!_hasEditingButton)
        {
            ...
            [_sendButton setImage:[TGPresentation classicIOS6Style] ? [TGPresentationAssets inputPanelConfirmIcon:UIColorRGB(0x2a2a2a) color:UIColorRGB(0xf0f0f0)] : self.presentation.images.chatInputConfirmIcon forState:UIControlStateNormal];
        }
        ...
        if (_hasEditingButton)
        {
            ...
            [_sendButton setImage:[TGPresentation classicIOS6Style] ? [TGPresentationAssets inputPanelSendIcon:UIColorRGB(0x2a2a2a) color:UIColorRGB(0xf0f0f0)] : self.presentation.images.chatInputSendIcon forState:UIControlStateNormal];
        }
...
- (void)updateButtonIcon
{
    ...
    {
        UIColor *iconColor = UIColorRGB(0xf0f0f0);
        _micButton.icon = videoMessage ? [TGPresentationAssets inputPanelVideoMessageIcon:iconColor] : [TGPresentationAssets inputPanelMicrophoneIcon:iconColor];
        _micButtonIconView.image = videoMessage ? [TGPresentationAssets inputPanelVideoMessageIcon:iconColor] : [TGPresentationAssets inputPanelMicrophoneIcon:iconColor];
        return;
    }
...
- (void)setIsBroadcasting:(bool)isBroadcasting {
    if (_isBroadcasting != isBroadcasting) {
        ...
        UIColor *modeIconColor = [TGPresentation classicIOS6Style] ? UIColorRGB(0xf0f0f0) : UIColorRGB(0xa0a7b0);
        UIImage *broadcastImage = [TGPresentation classicIOS6Style] ? [TGPresentationAssets inputPanelBroadcastIcon:modeIconColor active:_isBroadcasting] : TGTintedImage(_isBroadcasting ? TGImageNamed(@"ConversationInputFieldBroadcastIconActive.png") : TGImageNamed(@"ConversationInputFieldBroadcastIconInactive.png"), modeIconColor);
...
- (void)setMessageEditingContext:(TGMessageEditingContext *)messageEditingContext animated:(bool)animated {
    if (messageEditingContext != _messageEditingContext) {
        ...
        if ([TGPresentation classicIOS6Style])
            [_attachButton setImage:[TGPresentationAssets inputPanelAttachIcon:UIColorRGB(0xf0f0f0) accentColor:_messageEditingContext.hasMedia ? UIColorRGB(0xf0f0f0) : nil] forState:UIControlStateNormal];
        else if (_messageEditingContext.hasMedia)
