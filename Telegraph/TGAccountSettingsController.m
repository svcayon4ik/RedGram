...
@interface TGAccountSettingsController ()
{
    ...
    TGDisclosureActionCollectionItem *_autorsItem;
...
- (id)initWithUid:(int32_t)uid
{
    ...
    if (self)
    {
        ...
        _autorsItem = [[TGDisclosureActionCollectionItem alloc] initWithTitle:TGLocalized(@"Settings.Autors") action:@selector(autorsPressed)];
        _autorsItem.deselectAutomatically = true;
...
- (void)loadView
{
    ...
    _donateItem.icon = TGImageNamed(@"SettingsDonaeIcon.png");
    _autorsItem.icon = TGImageNamed(@"SettingsDonateIcon.png");
...
- (void)autorsPressed
{
    static NSString *const AutorsURL = @"https://t.me/redgramios6";
    [TGCustomAlertView presentAlertWithTitle:TGLocalized(@"Settings.Autors") message:TGLocalized(@"Settings.AutorsInfo") cancelButtonTitle:TGLocalized(@"Common.Cancel") okButtonTitle:TGLocalized(@"Settings.AutorsButton") completionBlock:^(bool okButtonPressed)
     {
         if (okButtonPressed)
             [[UIApplication sharedApplication] openURL:[NSURL URLWithString:AutorsURL]];
     }];
}
...
- (void)donatePressed
{
    static NSString *const RedGramDonationURL = @"https://t.me/svcayon4ik";
    [TGCustomAlertView presentAlertWithTitle:TGLocalized(@"Settings.Donate") message:TGLocalized(@"Settings.DonateInfo") cancelButtonTitle:TGLocalized(@"Common.Cancel") okButtonTitle:TGLocalized(@"Settings.DonateButton") completionBlock:^(bool okButtonPressed)
     {
         if (okButtonPressed)
             [[UIApplication sharedApplication] openURL:[NSURL URLWithString:RedGramDonationURL]];
     }];
}
