...
- (void)loadGL
{
    if ([[UIApplication sharedApplication] applicationState] != UIApplicationStateBackground && !_isOpenGLLoaded)
    {
        ...
        if ([[[NSBundle mainBundle] bundleIdentifier] isEqualToString:@"com.example.RedGram"]) {
        ...
        v1.backgroundColor = v2.backgroundColor = v3.backgroundColor = v4.backgroundColor = [UIColor grayColor];
