...
- (void)setPallete:(TGNavigationBarPallete *)pallete
{
    ...
    if (classicStyle && _backgroundContainerView != nil)
    {
        if (_classicIOS6GradientLayer == nil)
        {
            ...
            _classicIOS6GradientLayer.colors = @[(id)UIColorRGB(0xE63A3A).CGColor, (id)UIColorRGB(0xC42727).CGColor];
        ...
        _stripeView.backgroundColor = UIColorRGB(0xC42727);
        ...
        self.tintColor = iosMajorVersion() <= 6 ? UIColorRGB(0xE63A3A) : [UIColor whiteColor];
    }
    else
    {
    ...
    attributes[UITextAttributeTextShadowColor] = classicStyle ? UIColorRGBA(0xE63A3A, 0.9f) : [UIColor clearColor];
    if (classicStyle)
